...
\title{HERCULES User Manual \\ \large Version 1.0.1}
\author{Simon J. Lock}
...
After compilation (see Section~\ref{HUG:sec:compiling}) HERCULES is run by simply typing \texttt{.\/HERCULESv1.0} in the command line. 
...
An example make file, \texttt{Makefile}, is provided with the HERCULES source code.
